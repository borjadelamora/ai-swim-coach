# Current state — capacity now — TEMPLATE

> Copy this file to `current_state.md` and replace every placeholder with your own
...
- <Current status and the single remaining transition criterion.>
- Next bound: <the next step for the active skill project>.
